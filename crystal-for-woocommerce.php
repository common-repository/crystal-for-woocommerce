...
* Plugin URI: https://crystal.ai/be-a-happy-seller
...
const CRYSTAL_URL = 'https://crystal.ai';
const CRYSTAL_API_URL = 'https://crystal.ai/api';
const WEBHOOK_URL = 'https://crystal.ai/api/webhook/woocommerce';
